...
const PESTANAS = [
  { href: '/mi-diario', etiqueta: 'Inicio', icono: '🏠' },
  { href: '/mi-diario/hijo', etiqueta: 'Mi hijo', icono: '👶' },
  { href: '/mi-diario/mensajes', etiqueta: 'Mensajes', icono: '💬' },
  { href: '/mi-diario/calendario', etiqueta: 'Calendario', icono: '📅' },
  { href: '/mi-diario/mas', etiqueta: 'Más', icono: '⋯' },
]

// Barra de pestañas del padre: fija abajo en móvil (como una app),
// convertida en barra superior en escritorio (md+). Un solo
// componente, dos posiciones según el ancho de pantalla.
